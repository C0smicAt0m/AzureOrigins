...
public class DaybreakModel extends EntityModel<Daybreak> {
	private final ModelPart bb_main;
	public DaybreakModel(ModelPart root) {
	...
	@Override
	public void setAngles(Daybreak entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
