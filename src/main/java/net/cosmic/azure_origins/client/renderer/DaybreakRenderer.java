...
public class DaybreakRenderer extends EntityRenderer<Daybreak> {

    private static final Identifier TEXTURE =
            Identifier.of("azure_origins", "textures/entity/projectiles/daybreak.png");

    private final DaybreakModel model;

    public DaybreakRenderer(EntityRendererFactory.Context context) {
        super(context);
        // Use the model layer registered in the client initializer
        this.model = new DaybreakModel(context.getPart(AzureOriginsClient.DAYBREAK_LAYER));
    }

    @Override
    public void render(Daybreak entity, float yaw, float tickDelta, MatrixStack matrices,
    ...
    @Override
    public Identifier getTexture(Daybreak entity) {
        return TEXTURE;
    }
}
