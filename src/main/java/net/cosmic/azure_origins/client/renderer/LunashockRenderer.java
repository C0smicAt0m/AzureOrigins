...
import net.cosmic.azure_origins.entity.custom.projectiles.Lunashock;
...
public class LunashockRenderer extends EntityRenderer<Lunashock> {

    private static final Identifier TEXTURE =
            Identifier.of("azure_origins", "textures/entity/projectiles/lunashock.png");

    private final LunashockModel model;

    public LunashockRenderer(EntityRendererFactory.Context context) {
        super(context);
        // Use the model layer registered in the client initializer
        this.model = new LunashockModel(context.getPart(AzureOriginsClient.LUNASHOCK_LAYER));
    }

    @Override
    public void render(Lunashock entity, float yaw, float tickDelta, MatrixStack matrices,
    ...
    @Override
    public Identifier getTexture(Lunashock entity) {
        return TEXTURE;
    }
}
