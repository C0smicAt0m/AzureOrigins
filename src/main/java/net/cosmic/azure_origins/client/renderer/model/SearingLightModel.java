...
import net.cosmic.azure_origins.entity.custom.SearingLight;
...
public class SearingLightModel extends EntityModel<SearingLight> {
	private final ModelPart bb_main;
	public SearingLightModel(ModelPart root) {
	...
	@Override
	public void setAngles(SearingLight entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
